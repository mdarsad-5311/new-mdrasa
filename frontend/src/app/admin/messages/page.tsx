               ...
               <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                     ...
                     <tbody className="divide-y divide-background">
                        {loading ? (
                           <tr key="loading"><td colSpan={5} className="text-center py-10 opacity-50 font-bold">Loading records...</td></tr>
                        ) : messages.length === 0 ? (
                           <tr key="empty"><td colSpan={5} className="text-center py-10 opacity-50 font-bold">No messages found.</td></tr>
