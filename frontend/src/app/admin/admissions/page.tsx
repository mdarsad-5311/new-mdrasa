               ...
               <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                     ...
                     <tbody className="divide-y divide-background">
                        {loading ? (
                           <tr key="loading"><td colSpan={6} className="text-center py-10 opacity-50 font-bold">Loading records...</td></tr>
                        ) : applications.length === 0 ? (
                           <tr key="empty"><td colSpan={6} className="text-center py-10 opacity-50 font-bold">No applications found.</td></tr>
                           ...
                           <tr key={app._id} className="group hover:bg-background/20 transition-all duration-300">
                              ...
                              <td className="py-8 px-6">
                                 <span className={`inline-flex items-center gap-2 text-[9px] font-black uppercase tracking-widest px-4 py-2 rounded-full border ${app.status === "approved" ? "bg-green-50 text-green-600 border-green-100" :
