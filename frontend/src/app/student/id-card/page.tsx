    ...
    >
      <div className="max-w-360 mx-auto px-4 md:px-10 space-y-12 pb-20 relative">
        ...
        <div className="flex justify-center items-center py-12 bg-primary/2 rounded-3xl border border-primary/5 shadow-inner">
           ...
           {/* The Identity Card */}
           <div className="relative w-full max-w-105 aspect-[1.6/1] md:aspect-[0.63/1] bg-primary-dark rounded-4xl shadow-2xl overflow-hidden flex flex-col group hover:shadow-[0_40px_80px_-20px_rgba(6,78,59,0.4)] transition-all duration-700">
              ...
              <div className="flex-1 p-10 space-y-10 relative z-10 text-white">
                 <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="relative group/photo">
                       ...
                       <div className="absolute inset-0 bg-accent/20 rounded-full blur-3xl opacity-30 transform group-hover/photo:scale-150 transition-all duration-1000"></div>
                    </div>
