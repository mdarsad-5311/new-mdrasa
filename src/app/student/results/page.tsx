...
export default function ResultsPage() {
  const resultData = [
    { subject: "Hifz Quran", obtained: "95", total: "100", grade: "A+", remarks: "Excellent Memorization" },
    { subject: "Tajweed-ul-Quran", obtained: "92", total: "100", grade: "A+", remarks: "Perfect Pronunciation" },
    { subject: "Urdu Literature", obtained: "88", total: "100", grade: "A", remarks: "Good Vocabulary" },
    { subject: "Arabic Language", obtained: "90", total: "100", grade: "A+", remarks: "Fluent Reading" },
    { subject: "Islamic Studies", obtained: "94", total: "100", grade: "A+", remarks: "In-depth Knowledge" },
  ];
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 space-y-12 pb-20 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
           {[
             { label: "Latest Exam Score", value: "92%", icon: Target, color: "bg-primary text-white", sub: "Month: March", trend: "+2.4%" },
             { label: "Overall Performance", value: "A+", icon: Award, color: "bg-white", sub: "Excellent Rank", trend: "Grade" },
             { label: "Rank In Batch", value: "3rd", icon: Trophy, color: "bg-white", sub: "Out of 45 Students", trend: "High" },
             { label: "Hifz Progress", value: "Juz 14", icon: BookOpen, color: "bg-white", sub: "14/30 Memorized", trend: "47%" },
           ].map((stat, i) => (
                       ...
                       {resultData.map((row, idx) => (
                          <tr key={idx} className="group hover:bg-cream/30 transition-colors">
                             ...
                             <td className="px-8 py-7 text-left">
                                <p className="text-xs text-primary/50 font-medium leading-relaxed italic line-clamp-2">"{row.remarks}"</p>
                             </td>
                          </tr>
                       ))}
                    </tbody>
