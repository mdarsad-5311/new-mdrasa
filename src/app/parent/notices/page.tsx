...
export default function NoticesPage() {
  ...
  const announcements = [
    { 
      id: 1, 
      title: "Ramadan 2026 Holidays Announcement", 
      date: "Mar 12, 2026", 
      category: "Academic", 
      preview: "Madrasa Al-Umaima will remain closed during the holy month of Ramadan for the second half. Please check the full schedule.",
      new: true,
      attachment: "holiday-schedule.pdf",
      priority: "high"
    },
    { 
      id: 2, 
      ...
      date: "Mar 10, 2026", 
      category: "Event", 
      preview: "We invite all parents for the Quarterly Meeting next Sunday at 09:00 AM to discuss student performance and upcoming results.",
      new: false,
      attachment: null,
      priority: "medium"
    },
    { 
      id: 3, 
      title: "Revised Fee Structure Update", 
      date: "Mar 05, 2026", 
      category: "Fees", 
      preview: "Following the academic committee meeting, a slight revision to the transport and food charges will take effect from April 01.",
      new: false,
      attachment: "fee-revised-2026.pdf",
      priority: "medium"
    },
    { 
      id: 4, 
      title: "Inter-Madrasa Quran Recitation Competition", 
      date: "Mar 01, 2026", 
      category: "Event", 
      preview: "Register your child for the upcoming competition. Winners will be awarded at the Annual Day ceremony.",
      new: false,
      attachment: "competition-flyer.png",
      priority: "low"
    }
  ];
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 border-b border-border pb-12">
          <div className="space-y-2">
            ...
            <p className="text-sage text-sm font-medium tracking-widest uppercase">
              PORTAL: <span className="text-primary font-bold">AL-UMAIMA ACADEMY</span> | NOTICES: <span className="text-primary font-bold">04 ACTIVE</span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-12">
           ...
           <div className="xl:col-span-1 space-y-6">
              <div className="bg-white p-8 rounded-4xl shadow-soft border border-border space-y-4">
                 ...
                 {[
                   { label: "Internal Broadcast", category: "all", count: 4 },
                   { label: "Academic / Exams", category: "academic", count: 1 },
                   { label: "School Events", category: "event", count: 2 },
                   { label: "Fees & Accounts", category: "fees", count: 1 },
                   { label: "Urgent Alerts", category: "urgent", count: 1 }
                 ].map((cat, i) => (
                   <button 
                    key={i}
           ...
           <div className={`xl:col-span-3 grid gap-8 ${viewMode === "grid" ? "grid-cols-1 md:grid-cols-2" : "grid-cols-1"}`}>
              {announcements.map((notice, i) => (
                <div key={i} className="bg-white p-10 rounded-4xl shadow-soft border border-border space-y-8 hover:shadow-premium hover:-translate-y-1 transition-all group overflow-hidden relative">
                   {notice.new && <div className="absolute top-0 left-0 w-16 h-16 pointer-events-none transition-transform"><div className="absolute top-[-25px] left-[-25px] w-12 h-12 bg-accent rotate-45 flex items-center justify-end pr-2 pb-1 font-bold text-primary text-[8px] tracking-tighter">NEW</div></div>}
                   ...
                   <div className="space-y-4">
                      <div className="flex justify-between items-start">
                         <div className="flex items-center gap-3">
                           ...
                           <span className="text-[10px] font-black text-sage uppercase tracking-[0.2em]">{notice.category}</span>
                         </div>
                   ...
                   <div className="pt-8 mt-4 border-t border-background flex flex-col sm:flex-row justify-between items-center gap-8">
                       <div className="flex items-center gap-3">
                          ...
                          <p className="text-sm font-bold text-primary uppercase tracking-widest">{notice.date}</p>
                       </div>
