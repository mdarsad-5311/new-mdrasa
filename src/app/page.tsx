    ...
    <div className={`flex flex-col min-h-screen bg-background ${isUrdu ? "font-urdu" : "font-sans"}`}>
      ...
      <section className="py-24 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: t("notice.n1_title"), date: t("notice.n1_date"), type: t("notice.type_adm"), desc: t("notice.n1_desc") },
              { title: t("notice.n2_title"), date: t("notice.n2_date"), type: t("notice.type_res"), desc: t("notice.n2_desc") },
              { title: t("notice.n3_title"), date: t("notice.n3_date"), type: t("notice.type_hol"), desc: t("notice.n3_desc") }
            ].map((notice, n) => (
              <div key={n} className={`bg-white/40 backdrop-blur-sm rounded-2xl p-8 border border-primary/5 hover:border-accent group transition-all cursor-pointer relative overflow-hidden ${isUrdu ? "text-right" : "text-left"}`}>
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <p className={`text-text-dark/60 text-sm leading-relaxed ${isUrdu ? "font-urdu text-lg" : ""}`}>{notice.desc}</p>
